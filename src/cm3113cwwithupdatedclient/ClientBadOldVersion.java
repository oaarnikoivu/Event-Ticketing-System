...
public class ClientBadOldVersion extends Thread {

    private int thePortNo;
    private boolean connected = false;
    private ClientGUIBadOldVersion gui;
    private Socket socket;
    private BufferedReader theInput;
    private PrintWriter theOutput;

    public ClientBadOldVersion(int portNo) {
        thePortNo = portNo;
    }

    public ClientBadOldVersion(int portNo, ClientGUIBadOldVersion g) {
        thePortNo = portNo;
        gui = g;
    }
    ...
    public void sendTicketRequest(String name, int num) {
        ...
        while(!this.connected){
            try {
                ...
                Logger.getLogger(ClientBadOldVersion.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        if (this.connected) {        
